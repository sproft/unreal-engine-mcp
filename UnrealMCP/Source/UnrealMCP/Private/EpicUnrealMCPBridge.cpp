...
UEpicUnrealMCPBridge::UEpicUnrealMCPBridge()
{
    ...
    SproftAnimationGraphEdit = MakeShared<FSproftAnimationGraphEditCommands>();
}
...
UEpicUnrealMCPBridge::~UEpicUnrealMCPBridge()
{
    ...
    SproftAnimationGraphEdit.Reset();
}
...
FString UEpicUnrealMCPBridge::ExecuteCommand(const FString& CommandType, const TSharedPtr<FJsonObject>& Params)
{
    ...
    AsyncTask(ENamedThreads::GameThread, [this, CommandType, Params, Promise = MoveTemp(Promise)]() mutable
    {
        ...
        try
        {
            ...
            else if (CommandType == TEXT("landscape_edit"))
            {
                ResultJson = SproftLandscapeEdit->HandleCommand(CommandType, Params);
            }
            ...
            else if (CommandType == TEXT("animation_graph_edit"))
            {
                ResultJson = SproftAnimationGraphEdit->HandleCommand(CommandType, Params);
            }
            else
            {
